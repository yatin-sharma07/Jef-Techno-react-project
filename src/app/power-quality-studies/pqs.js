...
const PQS = () => {
  ...
  const components = [
    ...
    },
    {
      ...
      description: 'Analyzing current distortions and their impact on equipment.',
    },
    {
    ...
    <section>
      <div className="overflow-hidden py-20 w-full bg-stone-900 max-md:pt-24 px-5 md:px-12 lg:px-0 max-md:mt-10 max-md:w-full">
        <div className="flex flex-col lg:flex-row w-full xl:w-[95%] gap-5 max-md:flex-col">
          ...
          <div className={`relative flex flex-col w-[56%] max-sm:h-[100vh] max-lg:h-[47vh] overflow-hidden max-md:ml-0 max-lg:w-full ${isScreenTall ? '2xl:min-h-[120vh]' : ''}`}>
            <div
