...
const Solution8 = () => {
    ...
    const navItems = [
        ...
        { label: 'LIGHTNING PROTECTION DESIGN', isActive: false },
    ];
    ...
    const components = [

        {
            ...
            description: 'Design solutions from our good experience and qualified technical engineers.',
        },
        {
            id: 2,
            imageSrc: './SerivePage/02.png',
            description: 'LPS & Earthing designs meet relevant National and International standards.',
        },
        {
            id: 3,
            imageSrc: './SerivePage/03.png',
            description: 'End to end solutions covering risk assessment, determining the level of protection, and arriving at robust and optimum designs.',
        },
        {
            id: 4,
            imageSrc: './SerivePage/04.png',
            description: 'BOM including type-tested components as per standards.',
        },
        {
            id: 5,
            imageSrc: './SerivePage/05.png',
            description: 'Experience and the software to provide an accurate & optimum design.',
        },
        {
            id: 6,
            imageSrc: './SerivePage/06.png',
            description: 'Offering effective and accurate LPS designs for various challenging environments and critical & special applications.',
        },
    ]
    ...
    return (
        ...
        /> */}
                    <video autoPlay loop muted playsInline className="absolute size-full object-cover" >
                        <source src="./SerivePage/Solution-8.mp4" type="video/mp4" />
                ...
                <header className="flex p-4 ContactUsAnimation flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
                    <h1 className="flex flex-col max-w-full text-2xl  font-medium uppercase leading-relaxed tracking-wider w-[1071px]">
                        <div className="w-full max-md:max-w-full">
                            LIGHTNING PROTECTION DESIGN SOLUTIONS
                        </div>
                    </h1>
                    <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">We offer comprehensive Lightning Protection system design services and provide end-to-end solutions covering risk assessment, determining the level of protection, and arriving at designs, BOM and specifications through advanced software.
                    </p>
                    <p className="self-stretch mt-6 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">Bill of material includes products which are sequentially type tested as per IS/IEC 62561 (62305) for aging, 100kA Lightning Impulse of 10/300 µs waveform, Mechanical test which is in line with various National & International Standards. We offer products for Lightning Protection & Grounding to suit various applications.
                    </p>
                    <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">The process involves a site survey, collection of basic data and drawings, earthing system analysis, risk assessment, and arriving at cost-optimal lightning protection system design.
                    </p>
                    <p className="self-stretch mt-6 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">We at JEF have developed an in-house Automated Risk Assessment & Design Tool-
                    </p>
                    <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">JEF Shield, as per IS /IEC 62305 for assessing the lightning risk and offering the best optimal solution including risk assessment report, concept design drawings & bill of materials in &lt;99 seconds with a click of a button.
                    </p>
                </header>
    ...
    const cardContents = [
        {
            ...
            title: "Benefits of JEF Shield Tool",
            description:
                "|Risk Assessment & Cost Optimal Solution|Generating concept drawings, 3D Models & installation details|Bill of material|Estimated cost for tendering & budgetary purposes.|Provision to upload your drawings|Detailed engineering",
        },
        {
            imgSrc:
                "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
            title: "Other Highlights of JEF Shield",
            description:
                "|User-friendly dashboard|Track & modify your projects|Get all the project deliverables in <99 seconds|Secure access- Password + OTP",
        },
        {
            imgSrc:
                "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
            ...
            description:
                "|Design solutions from our good experience and qualified technical engineers.|LPS & Earthing designs meet relevant National and International standards.|End to end solutions covering risk assessment, determining the level of protection, and arriving at robust and optimum designs.|BOM including type-tested components as per standards.|Experience and the software to provide an accurate & optimum design.|Offering effective and accurate LPS designs for various challenging environments and critical & special applications. ",
        },
        {
            imgSrc:
                "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
