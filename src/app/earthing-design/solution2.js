...
const Solution2 = () => {
    ...
    const navItems = [
        ...
        { label: 'EARTHING DESIGN', isActive: false },
    ];
    ...
    const components = [

        {
            ...
            description: 'Electrical Grounding System Design solutions from our good experience and qualified technical engineers.',
        },
        {
            id: 2,
            imageSrc: './SerivePage/02.png',
            description: 'LPS & Earthing designs comply with all relevant National and International standards.',
        },
        {
            id: 3,
            imageSrc: './SerivePage/03.png',
            description: 'Optimized earthing design solution using world-renowned CDEGS Software.',
        },
        {
            id: 4,
            imageSrc: './SerivePage/04.png',
            description: 'Level-2 certified in CDEGS software proficiency.',
        },
        {
            id: 5,
            imageSrc: './SerivePage/05.png',
            description: 'Engineered designs to meet client specifications focusing on earthing & lightning protection issues and concerns.',
        },
        {
            id: 6,
            imageSrc: './SerivePage/06.png',
            description: 'Experience to provide the optimum design solutions',
        },
        {
            id: 7,
            imageSrc: './SerivePage/07.png',
            description: 'Offering effective and accurate earthing designs for a various challenging environments and critical & special applications.',
        },
    ]
    ...
    return (
        ...
        /> */}
                    <video autoPlay loop muted playsInline className="absolute size-full object-cover" >
                        <source src="./SerivePage/Solution-2.mp4" type="video/mp4" />
                ...
                <header className="flex p-4 ContactUsAnimation flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
                    <h1 className="flex flex-col max-w-full text-2xl  font-medium uppercase leading-relaxed tracking-wider w-[1071px]">
                        <div className="w-full max-md:max-w-full">
                            GROUNDING/EARTHING DESIGN SOLUTIONS
                        </div>
                    </h1>
                    <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">
                        We provide a one-stop solution offering you the design services with the help of CDEGS software and ensure the most accurate and cost-effective solution.
                    </p>
    ...
    const cardContents = [
        {
            ...
            description:
                "|A comprehensive soil resistivity test is important in an effective earthing system design, as inadequate or erroneous soil resistivity readings are likely to result in a flawed design. It is the key factor that determines the resistance or performance of an electrical grounding system.|Accurate soil resistivity data enables precise designs and predictable results. The type of soil, moisture, electrolytic content, and temperature also affect soil resistance. Frost line depth, water table level, bedrock, and available space dictate some specifics of the grounding system design.",
        },
        {
            imgSrc:
                "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
        ...
        },
        {
            ...
            description:
                "|Lightning Protection system analysis is a critical component in comprehensive grounding design. If the building and equipment are properly grounded, personnel injury and equipment damage can be reduced or eliminated entirely.|The purpose of a lightning protection system is to provide a path for the lightning strike to pass through the ground without damaging personnel or sensitive equipment in the building, and this can be achieved if a proper and effective grounding system is in place.",
        },
        {
            imgSrc:
                "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
