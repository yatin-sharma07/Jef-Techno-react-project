...
function JobInfoSection() {
    ...
    const Profile = [
        "Diploma/ BE/ B.Tech In Electrical and Electronic Engineering with a minimum of 5+ years experience in the electrical field.",
        "Academic excellence with a minimum score of 50% in Engineering.",
        "Flexibility to travel extensively across Pan India & overseas location for project assignments.",
        "Good oral communication in both English and Hindi is essential for effective collaboration and client interaction.",
        "Should be a good team player.",
        "Proficiency in software applications such as Dran-View, Power Log, PAT-2, Etap, AutoCAD, Fluke and other power quality meter Class-A Analyzers software",
        "Should have hardware knowledge encompassing Class-A power Analyzer connections, operations, configuration, and topology.",
    ...
    const Responsibility = [
        "Thoroughly review and understand the project's scope of work and customer expectations for deliverable. Validate and seek confirmation from the Team Lead/Manager to ensure alignment.",
        "Should travel extensively across pan India/Overseas to conduct site visits alongside senior engineers and perform audit services.",
        "Candidate must be willing to remain on project sites until the completion of the project.",
        "Responsibly inspecting test equipment and accessories to ensure they are functioning properly for tests, and promptly informing the manager of any issues. Ensuring the safe return of meters to the company without any damage.",
        "Ensure prompt and accurate documentation of field data within the company's designated application.",
        "Ensuring the completeness and adequacy of collected data for the project.",
        "Effective coordination with site teams, customers, and the back-end team to facilitate seamless operations.",
        "Sound understanding of relevant standards and testing procedures.",
        "Active participation in discussions regarding report findings and recommendations.",
        "Eagerness to engage in training sessions to enhance skills and knowledge base.",
        "Thoroughly review and understand the project's scope of work and customer expectations for deliverable. Validate and seek confirmation from the team Lead/manager to ensure alignment.",
        "Should travel extensively across pan India/Overseas to conduct site visits and to perform audit services.",
        "Should take care of personal safety during travel, field audit and testing",
        "Should ensure strict adherence and compliance to the test methodologies and SOPs",
    ];
