...
const iconTextItems = [
  ...
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/aad532364fe57b522dac121a9ba4aad021d2c2f53556e2277d6daa3ba45b1580?placeholderIfAbsent=true&apiKey=ec02862acd164f0aad3ceef0d2a999c3", text: "Chennai" }
];
...
function JobInfoSection() {
  ...
  const Profile = [
    "BE/ B.Tech (Electrical and Electronics) with 2-5 years experience in sales and marketing of Electrical Products. Preferably from an electrical manufacturing organization.",
    "Prior experience with Consultants, Contractors, B2B, B2C & Handling Key Account Management are essential.",
    "Knowledge In Lightning Protection & Earthing will be an added Advantage.",
    "Candidate should be willing to travel for at least 3-4 days each week within his region & outside his base location.",
    "Proficient in MS Office (Word, Excel & Power Point).",
    "The ideal candidate should be a proven performer who has delivered the result consistently",
    "Excellent presentation and communication skills, good organization skills, problem solving and analytical skills.",
    "Should be a good team player.",
    "Identify and engage new dealers to expand our network.",
    "The candidate should adhere to the organization’s requirements of weekly reporting of forecast & target achievement.",
    "The ideal candidate will conduct comprehensive market analysis to evaluate revenue and profitability, develop tailored marketing strategies for various market segments, and proficiently create customer presentations.",
    "Good oral & written communication in English is essential.",
    "Good oral communication in Hindi & Regional Language are essential. Excellent communication, presentation and telephonic skills.",
    "Excellent communication, presentation and telephonic skills.",
  ];

  const Responsibility = [
    "Responsible for engaging with current clientele, prospecting for new leads, and delivering presentations showcasing the company's diverse product offerings.",
    "Collaborate with the internal team and customers to review the RFQs, Technical Specifications and coordination with the internal team to work on pricing strategies, commercial terms, and product specifications in order to secure orders.",
    "Monitor and stay informed about competitors, competitive trends, products, and market dynamics while consistently enhancing product knowledge.",
    "Manage tender participation via Channel Partners and Contractors, leading discussions, negotiations, and outlining precise scopes of work.",
    "The ideal candidate will conduct comprehensive market analysis to evaluate revenue and profitability, develop tailored marketing strategies for various market segments, and proficiently create customer presentations.",
    "The candidate should adhere to the organization’s requirements of weekly reporting of forecast & target achievement.",
    "Preparing quotations, offers and work orders accurately and efficiently.",
    "Coordinate effectively with technical teams, design teams, project teams, supply chain management, and clients to ensure seamless project execution.",
  ];   
  ...
  const whatweoffer = [
    ...
    "Structured learning & upskilling programs conducted by subject matter experts Structured leadership development initiatives designed to foster professional growth and advancement",
    ...
    <section className="flex flex-col pb-10 w-[76%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col grow items-start mt-6 text-base text-stone-900 max-md:mt-10 max-md:max-w-full">
        ...
        <section>
          ...
          <h3 className="mt-8 font-semibold">Our Products : Earthing & LPS Products</h3>
          <h3 className="mt-8 font-semibold">500+ Certified Products for Reliable Lightning Protection and Grounding Systems</h3>
          <Paragraph>
          We have a comprehensive range of Earthing and LPS products, as well as the resources, scale, and agility to deliver projects efficiently at the best value. JEF has been a trusted partner for a diverse range of customers across industries - Renewable Energy, Commercial, Residential Buildings, Data Centres, Oil and Gas, Railways and more.
          </Paragraph>
          <Paragraph>
          Our customer centric approach backed with a thorough knowledge of the nuances of various applications are cost optimum, technically superior and practically implementable besides complying to relevant regulations.
          </Paragraph>
          ...
          <h2 className="text-xl font-light mt-6">Designation: Business Development Manager</h2>
          <h2 className="text-xl font-light mt-3">Reporting To: Regional Manager - South</h2>
