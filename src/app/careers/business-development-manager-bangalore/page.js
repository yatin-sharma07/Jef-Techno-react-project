...
function JobInfoSection() {
    ...
    const Profile = [
        "BE/ B.Tech (Electrical and Electronics) with 0-2 years experience in sales and marketing of Electrical Products. Preferably from an electrical manufacturing organization.",
