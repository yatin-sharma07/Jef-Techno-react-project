...
const iconTextItems = [
  ...
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/aad532364fe57b522dac121a9ba4aad021d2c2f53556e2277d6daa3ba45b1580?placeholderIfAbsent=true&apiKey=ec02862acd164f0aad3ceef0d2a999c3", text: "Coimbatore" }
];
...
function JobInfoSection() {
  ...
  const Profile = [
    ...
    "Develop and nurture relationships with both new and existing customers, consultants, architects, contractors, and end users to foster future opportunities.",
    ...
    "Good oral communication in Hindi & Regional Language are essential.",
