...
function JobInfoSection() {
    ...
    const Profile = [
        "Diploma/ BE/B.Tech In Electrical and Electronic Engineering with a minimum of 0-1 year experience in the electrical field.",
        ...
        <section className="flex flex-col pb-10 w-[76%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow items-start mt-6 text-base text-stone-900 max-md:mt-10 max-md:max-w-full">
                ...
                <section>
                    ...
                    <h2 className="text-xl font-light mt-6">Designation: GET</h2>
                    <h2 className="text-xl font-light mt-3">Reporting To: Dy Manager</h2>
