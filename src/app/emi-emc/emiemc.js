...
const EmiEmc = () => {
    ...
    const components = [

        {
            ...
            description2: 'Detailed analysis of interference levels affecting system performance.',
        },
        {
            imageSrc: './SerivePage/02.png',
            title: 'Shielding Effectiveness Evaluation',
            description: 'Assessment of shielding effectiveness in protecting sensitive areas from electromagnetic disturbances.',
            description2: 'Recommendations for improving shielding to ensure system reliability.',
        },
        {
            imageSrc: './SerivePage/03.png',
            title: 'Grounding and Bonding Assessments',
            description: 'Evaluation of grounding and bonding systems to minimize electromagnetic emissions.',
            description2: 'Design recommendations for improving system grounding, ensuring compatibility with sensitive devices.',
        },
        {
            imageSrc: './SerivePage/04.png',
            title: 'EMC Compliance Testing',
            description: 'Conducting tests to ensure equipment and systems comply with international EMC standards such as IEC 61000.',
            description2: 'Providing actionable insights for achieving regulatory compliance.',
        },
        {
            imageSrc: './SerivePage/05.png',
            title: 'Mitigation Solutions',
            description: 'Tailored solutions for mitigating EMI issues, including filtering, shielding, and redesigning system layouts.',
            description2: 'Implementation of advanced techniques to enhance electromagnetic compatibility.',
        },
        {
            imageSrc: './SerivePage/06.png',
            title: 'Simulation and Modelling',
            description: 'Utilizing cutting-edge tools for simulating electromagnetic environments and analyzing interference patterns.',
            description2: 'Designing optimized layouts to minimize EMI risks.',
        },
    ]
        ...
        /> */}
                    ...
                    <div className="flex Y-axis-text-Title-Service1 inset-y-3/4 lg:-mt-[2%] 2xl:mt-0 lg:inset-x-20 p-4 relative flex-col self-center w-full max-md:mt-10 max-md:max-w-full mb-0 mx-40 max-w-full max-md:mb-2.5">
                        <h1 className=" lg:text-5xl md:text-4xl text-3xl font-bold my-auto tracking-wider text-white max-md:max-w-full max-md:text-4xl">
                            EMI EMC & AC INTERFERENCE STUDIES
                        </h1>
            ...
            <section className="flex h-auto -mb-11 md:mb-0 overflow-hidden flex-col bg-stone-900">
                ...
                <header className="flex p-4 ContactUsAnimation flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
                    ...
                    <p className="self-stretch mt-12 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:mt-10 max-md:max-w-full">
                        Corrosion of pipeline due to induced current from the Power Transmission Lines and cables is a major area of concern for pipeline operators. JEF offers comprehensive simulation studies to identify areas of concern and suggest mitigation strategies.
                    </p>
                </header>
