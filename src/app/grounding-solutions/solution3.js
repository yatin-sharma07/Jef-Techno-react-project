...
const Solution3 = () => {
    ...
    const navItems = [
        ...
        { label: 'GROUNDING SOLUTION', isActive: false },
    ];
    ...
    const components = [

        {
            ...
            description: 'Cost-effective solution for reliable and robust grounding system.',
        },
        {
            id: 2,
        ...
        },
        {
            ...
            description: 'Indigenized Earthing Compound offering Maintenance-free Grounding solution.',
        },
        {
            id: 4,
            imageSrc: './SerivePage/04.png',
            description: 'Electrode (UL-listed) and compound type tested as per IEC-62561-7, IS3043-2018 & IEEE 80.',
        },
        {
            id: 5,
            imageSrc: './SerivePage/05.png',
            description: 'A Comprehensive solution as per national and international standards IS-3043, BS-7430 & IEEE-80, IEC 62561-7 (For backfill compound), and IEC-60364-5 for a permanent solution to lower earth resistance.',
        },
    ]
    ...
    return (
        ...
        /> */}
                    <video autoPlay loop muted playsInline className="absolute size-full object-cover" >
                        <source src="./SerivePage/Solution-3.mp4" type="video/mp4" />
                ...
                <header className="flex p-4 ContactUsAnimation flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
                    <h1 className="flex flex-col max-w-full text-2xl  font-medium uppercase leading-relaxed tracking-wider w-[1071px]">
                        <div className="w-full max-md:max-w-full">
                            Reduce equipment failure and improve <br className="hidden md:block" /> safety & reliability
                        </div>
                    </h1>
                    ...
                    <p className="self-stretch mt-6 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">
                        A good grounding system is important for <br />
                        <li>Human/Life Safety</li>
                        <li>Limiting damage to electrical equipment in case of fault/lightning</li>
                        <li>Correct operation of the electricity supply network and to ensure good power quality</li>
                    </p>
                    <p className="self-stretch mt-6 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">
    ...
    const cardContents = [
        {
            ...
            description:
                "|Cost-effective solution for reliable and robust grounding system.|Ensures Human and Equipment Safety.|Indigenized Earthing Compound offering Maintenance-free Grounding solution.|Electrode (UL-listed) and compound type tested as per IEC-62561-7, IS3043-2018 & IEEE 80.  |A Comprehensive solution as per national and international standards IS-3043, BS-7430 & IEEE-80, IEC 62561-7 (For backfill compound), and IEC-60364-5 for a permanent solution to lower earth resistance.",
        },
        {
            imgSrc:
                "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
            ...
            description:
                "AIS & GIS Substations, Commercial Buildings, Retails outlets, Warehouses, Data Centres, Factories, Manufacturing Plants, Oil & Gas, Metro rail, Process plants, Wind & Solar Plants, Tank farms, Critical structures like communication towers, power plants and more.",
        },
        {
            imgSrc:
                "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
            ...
            description:
                "| IEEE 81-2012, IEE Regulation, CEA regulations for measures relating to safety and electric supply - 2021 (Draft), IEEE 80 – 2013, IS 3043, BS 7430, CBIP manual-339, IEC 62561-7.|Jef has now come out with excellent products to achieve lower resistance in an environment-friendly way. JEF grounding components are manufactured to ensure a reliable and robust grounding system. Grounding Products are strictly in line with the national and international Standards; IS 3043, BS 7430, IEEE80 & IEC 62561-7.",
        },
    ];
                ...
                <div className="flex flex-col lg:flex-row w-full xl:w-[95%] gap-5 max-md:flex-col">
                    ...
                    <div className="relative flex flex-col w-[56%] max-sm:h-[110vh] max-lg:h-[55vh] overflow-hidden max-md:ml-0 max-lg:w-full">
                        <div
                            ...
                            style={{ transform: `translateY(-${(activeIndex * 100) / 3}%)` }}
                        >
                                            ...
                                            <div className="flex h-auto flex-col w-full max-md:w-full">
                                                ...
                                                {content.description.split("|").map((sentence, idx) => {
                                                    ...
                                                    const specialSentences = [
                                                        "Jef has now come out with excellent products to achieve lower resistance in an environment-friendly way.",
                                                        "JEF grounding components are manufactured to ensure a reliable and robust grounding system. Grounding Products are strictly in line with the national and international Standards; IS 3043, BS 7430, IEEE80 & IEC 62561-7.",
                                                    ];
