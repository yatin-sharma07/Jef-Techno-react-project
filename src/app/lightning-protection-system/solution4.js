...
const Solution4 = () => {
  ...
  const navItems = [
    ...
    { label: 'LIGHTNING PROTECTION SYSTEM', isActive: false },
  ];
      ...
      <section className="flex overflow-hidden h-screen flex-col bg-white">
        ...
        /> */}
          <video autoPlay loop muted playsInline className="absolute size-full object-cover" >
            <source src="./SerivePage/Solution-4.mp4" type="video/mp4" />
      ...
      <section className="flex h-auto -mb-11 md:mb-0 overflow-hidden flex-col bg-stone-900">
        ...
        <header className="flex p-4 ContactUsAnimation flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
          ...
          <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">
            Lightning is an act of God that risks life and assets. One cannot avoid it. There is no known method of preventing the occurrence of natural phenomena such as a Lightning Strike / Flash/Discharge. A prudent approach will be to measure and manage the lightning risk for adequate protection.
          </p>
          <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-medium max-md:max-w-full">
            EFFECTIVE AND RELIABLE PROTECTION IS THE ONLY SOLUTION.
          </p>
          <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">
            IEC 62305 clearly emphasizes the need not only to protect the structure and people against lightning but also to protect the electrical and electronic equipment located inside the structure from conducted surges using SPD and radiated surges using Faraday cage type LPS. Standard elaborates lightning risk assessment methodology to arrive at the required level of protection for structure & its electronics.
          </p>
          <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-medium max-md:max-w-full">
            OUR LIGHTNING PROTECTION SYSTEM OFFERINGS
          </p>
          <p className="self-stretch mt-10 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:max-w-full">
  ...
  const cardContents = [
    {
      ...
      description:
        "|Cost effective, reliable and customized solutions.|Ensures Human and Equipment Safety.|Lightning Protection System as per IS/IEC 62305-2010.|Complete range of Type tested LPS components as per IEC 62561(62305). Sequentially type tested: Ageing, (10/350µs)100kA Lightning impulse, Mechanical test.|Effective protection against lightning and switching transients-Offering wide range of SPDs: Power, Signal, Instrumentation, Ethernet, and Telecom lines.",
    },
    {
      imgSrc:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
    ...
    },
    {
      ...
      description:
        "|IS/IEC 62305| IEC 62561 | IS 3043 | IEC 60364",
    },
  ];
